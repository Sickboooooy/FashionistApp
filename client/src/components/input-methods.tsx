...
const InputMethods = () => {
  ...
  return (
    <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row md:space-x-6 justify-center mb-12">
      ...
      <div className="flex-1 max-w-xs mx-auto md:mx-0">
        <GoldBorder
          className="p-6 hover:border-amber-500/40 transition-all cursor-pointer h-48 flex flex-col items-center justify-center text-center group"
          onClick={openTextModal}
        >
          <i className="fas fa-keyboard text-3xl mb-4 text-amber-500/60 group-hover:text-amber-400 transition-colors"></i>
          <h3 className="font-serif text-lg mb-2 text-stone-100">Describe tus Necesidades</h3>
          <p className="text-sm text-stone-400 font-light mb-4">Cuéntanos qué estás buscando</p>
        </GoldBorder>
      </div>
    </div>
  );
