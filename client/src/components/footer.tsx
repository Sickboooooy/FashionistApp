...
const Footer = () => {
  return (
    <footer className="relative py-10 px-4 md:px-8 bg-gradient-to-b from-transparent to-black/40 before:content-[''] before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-amber-deep/70 before:to-transparent">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex space-x-4 justify-center md:justify-end">
              <a href="#" className="w-11 h-11 rounded-full border border-amber-deep/50 bg-white/[0.03] backdrop-blur-sm flex items-center justify-center hover:border-gold-light hover:bg-amber-deep/15 hover:-translate-y-0.5 transition-all duration-200" title="Instagram">
              ...
              <a href="#" className="w-11 h-11 rounded-full border border-amber-deep/50 bg-white/[0.03] backdrop-blur-sm flex items-center justify-center hover:border-gold-light hover:bg-amber-deep/15 hover:-translate-y-0.5 transition-all duration-200" title="Facebook">
              ...
              <a href="#" className="w-11 h-11 rounded-full border border-amber-deep/50 bg-white/[0.03] backdrop-blur-sm flex items-center justify-center hover:border-gold-light hover:bg-amber-deep/15 hover:-translate-y-0.5 transition-all duration-200" title="Pinterest">
              ...
              <a href="#" className="w-11 h-11 rounded-full border border-amber-deep/50 bg-white/[0.03] backdrop-blur-sm flex items-center justify-center hover:border-gold-light hover:bg-amber-deep/15 hover:-translate-y-0.5 transition-all duration-200" title="TikTok">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-4 h-4 text-amber-deep fill-current">
